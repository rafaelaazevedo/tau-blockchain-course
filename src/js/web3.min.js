...
})(
  {
            ...
            return this.isDynamicArray(e)
              ? (function () {
                  var o = t.length,
                    ...
                    a = [];
                  return (
                    a.push(r.formatInputInt(o).encode()),
              ...
              return (function () {
                for (
                  var o = r.staticArrayLength(n),
                    ...
                    c = 32 * Math.floor((s + 31) / 32),
                    u = [],
                    f = 0;
                  f < o * c;
                  f += c
                )
                  u.push(r.decode(t, i + f, a));
                return u;
              })();
    ...
    17: [
      function (t, e, n) {
        ...
        "undefined" == typeof XMLHttpRequest
          ? (n.XMLHttpRequest = {})
          : (n.XMLHttpRequest = XMLHttpRequest);
      },
      {},
    ],
    18: [
        ...
        var r = t("bignumber.js"),
          ...
          x = function (t) {
            return (
              ...
              I(t)
                ? t
                : !O(t) || (0 !== t.indexOf("0x") && 0 !== t.indexOf("-0x"))
          ...
          A = function (t) {
            ...
            for (var e = o(t), n = "0x", r = 0; r < t.length; r++)
              n += parseInt(e[r], 16) > 7 ? t[r].toUpperCase() : t[r];
            return n;
          },
          F = function (t) {
            return B(t)
    ...
    22: [
      function (t, e, n) {
        ...
        var o = t("./web3/requestmanager"),
          ...
          w = t("bignumber.js");
        (r.providers = { HttpProvider: b, IpcProvider: _ }),
        ...
        var x = function () {
          return [
            new v({ name: "version.node", getter: "web3_clientVersion" }),
            new v({
    ...
    29: [
      function (t, e, n) {
          ...
          u = function (t, e, n, r, o, i) {
            ...
            return (
              ...
              this.implementation.newFilter(this.options, function (t, e) {
                if (t)
                  u.callbacks.forEach(function (e) {
                    e(t);
                  }),
                    "function" == typeof i && i(t);
                else if (
                  ((u.filterId = e),
                  u.getLogsCallbacks.forEach(function (t) {
                    u.get(t);
                  }),
                  (u.getLogsCallbacks = []),
                  u.callbacks.forEach(function (t) {
                    s(u, t);
                  }),
                  u.callbacks.length > 0 && c(u),
                  "function" == typeof o)
                )
                  return u.watch(o);
              }),
        ...
        (u.prototype.watch = function (t) {
          return (
            this.callbacks.push(t), this.filterId && (s(this, t), c(this)), this
          );
        }),
          (u.prototype.stopWatching = function (t) {
            return (
              ...
              (this.callbacks = []),
              t
                ? void this.implementation.uninstallFilter(this.filterId, t)
      ...
      function (t, e, n) {
        var r = t("../utils/utils"),
          ...
          p = function (t) {
            return (
              null !== t.blockNumber &&
                (t.blockNumber = r.toDecimal(t.blockNumber)),
              null !== t.transactionIndex &&
                (t.transactionIndex = r.toDecimal(t.transactionIndex)),
          ...
          d = function (t) {
            return (
              (t.gasLimit = r.toDecimal(t.gasLimit)),
              (t.gasUsed = r.toDecimal(t.gasUsed)),
          ...
          b = function (t) {
            return (
              (t.startingBlock = r.toDecimal(t.startingBlock)),
        ...
        (c.prototype.extractCallback = function (t) {
          ...
          (c.prototype.toPayload = function (t) {
            ...
            return (
              ...
              (e.to = this._address),
              (e.data =
                "0x" + this.signature() + r.encodeParams(this._inputTypes, t)),
              e
            );
          }),
          ...
          (c.prototype.sendTransaction = function () {
            ...
            return e
              ? void this._eth.sendTransaction(n, e)
              : this._eth.sendTransaction(n);
          }),
          (c.prototype.estimateGas = function () {
            var t = Array.prototype.slice.call(arguments),
              ...
              n = this.toPayload(t);
            return e
              ? void this._eth.estimateGas(n, e)
              : this._eth.estimateGas(n);
          }),
      ...
      function (t, e, n) {
                ...
                n._parseResponse(t.toString()).forEach(function (t) {
                  ...
                  r.isArray(t)
                    ...
                    n.responseCallbacks[e] &&
                      (n.responseCallbacks[e](null, t),
                      delete n.responseCallbacks[e]);
                });
              });
          };
        (i.prototype._parseResponse = function (t) {
          ...
          (i.prototype.isConnected = function () {
            var t = this;
            return (
              t.connection.writable || t.connection.connect({ path: t.path }),
      ...
      function (t, e, n) {
        ...
        (r.toPayload = function (t, e) {
          return (
            ...
            r.messageId++,
            { jsonrpc: "2.0", id: r.messageId, method: t, params: e || [] }
          );
        }),
    ...
    44: [
      function (t, e, n) {
        ...
        e.exports = {
          global: { abi: r, address: i },
          icap: { abi: o, address: a },
        };
      },
      {
      ...
      function (t, e, n) {
        ...
        (s.prototype.send = function (t) {
          ...
          (s.prototype.startPolling = function (t, e, n, r) {
            (this.polls[e] = { data: t, id: e, callback: n, uninstall: r }),
          ...
          (s.prototype.poll = function () {
            if (
              ...
              if (!this.provider)
                return void console.error(a.InvalidProvider());
              var t = [],
                e = [];
                ...
                this.provider.sendAsync(s, function (t, e) {
                  if (!t) {
                    ...
                    e.map(function (t) {
                      var e = c[t.id];
                      return (
                        !!u.polls[e] && ((t.callback = u.polls[e].callback), t)
                      );
                    })
                      .filter(function (t) {
                        return !!t;
          ...
          a = function (t) {
            var e = function (e, n) {
              return e
                ...
                : (o.isObject(n) &&
                    n.startingBlock &&
                    (n = r.outputSyncingFormatter(n)),
                  void t.callbacks.forEach(function (e) {
                    t.lastSyncState !== n &&
              ...
              !(function () {
                ...
                for (var n = 0, r = 0, e = 0; e < 256; e++) {
                  ...
                  (s[n] = (v << 24) | (v >>> 8)),
                    ...
                    (f[n] = v);
                  var v =
                    (16843009 * g) ^ (65537 * y) ^ (257 * m) ^ (16843008 * n);
                  (l[o] = (v << 24) | (v >>> 8)),
                    (p[o] = (v << 16) | (v >>> 16)),
                    (h[o] = (v << 8) | (v >>> 24)),
                    (d[o] = v),
                    n
                      ? ((n = m ^ t[t[t[g ^ m]]]), (r ^= t[t[r]]))
                      : (n = r = 1);
                }
              })();
                ...
                y = (o.AES = r.extend({
                  _doReset: function () {
                    if (!this._nRounds || this._keyPriorReset !== this._key) {
                      ...
                      for (
                        var u = (this._invKeySchedule = []), f = 0;
                        f < o;
                        f++
                      ) {
                        var s = o - f;
              ...
              var n = t,
                ...
                x = (w.OpenSSL = {
                  execute: function (t, e, n, r) {
                    ...
                    return (
                      (o.sigBytes = 4 * e), g.create({ key: o, iv: a, salt: r })
                    );
                  },
                }),
    ...
    55: [
      function (t, e, n) {
        !(function (r, o, i) {
          "object" == typeof n
            ? (e.exports = n = o(t("./core"), t("./sha1"), t("./hmac")))
            : "function" == typeof define && define.amd
    ...
    56: [
      function (t, e, n) {
        !(function (r, o, i) {
          "object" == typeof n
            ? (e.exports = n = o(t("./core"), t("./cipher-core")))
            : "function" == typeof define && define.amd
    ...
    79: [
      function (t, e, n) {
        !(function (r, o, i) {
          "object" == typeof n
            ? (e.exports = n = o(t("./core"), t("./x64-core")))
            : "function" == typeof define && define.amd
    ...
    80: [
      function (t, e, n) {
        !(function (r, o, i) {
          "object" == typeof n
            ? (e.exports = n = o(t("./core"), t("./x64-core"), t("./sha512")))
            : "function" == typeof define && define.amd
                ...
                h = (s.DES = a.extend({
                  _doReset: function () {
                    ...
                    for (var i = (this._subKeys = []), a = 0; a < 16; a++) {
                      for (var s = (i[a] = []), l = f[a], r = 0; r < 24; r++)
                        (s[(r / 6) | 0] |=
                          n[(u[r] - 1 + l) % 28] << (31 - (r % 6))),
                          (s[4 + ((r / 6) | 0)] |=
                            n[28 + ((u[r + 24] - 1 + l) % 28)] <<
    ...
    84: [
      function (t, e, n) {
        !(function (t) {
          ...
          function c(t) {
            for (var e, n = r(t), o = n.length, i = -1, a = ""; ++i < o; )
              (e = n[i]), (a += s(e));
            return a;
          }
          function u() {
        ...
        !(function (t) {
          ...
          function n(t) {
            function e(t, n) {
              ...
              if (!(u instanceof e))
                return (
                  U && O(26, "constructor call without new", t), new e(t, n)
                );
              if (null != n && W(n, 2, 64, R, "base")) {
                if (((n |= 0), (c = t + ""), 10 == n))
                  return (
                    (u = new e(t instanceof e ? t : c)), N(u, M + u.e + 1, H)
                  );
                if (
                  ...
                  return D(u, c, a, n);
                a
                  ? ((u.s = 1 / t < 0 ? ((c = c.slice(1)), -1) : 1),
                    U && c.replace(/^0\.0*|\./, "").length > 15 && O(R, v, t),
                    (a = !1))
              ...
              if ((c = c.slice(i, s + 1)))
                if (
                  ((s = c.length),
                  a && U && s > 15 && (t > x || t !== m(t)) && O(R, v, u.s * t),
                  (o = o - i - 1),
                  o > L)
                )
                  u.c = u.e = null;
                  ...
                  if (
                    ...
                    for (i && u.c.push(+c.slice(0, i)), s -= w; i < s; )
                      u.c.push(+c.slice(i, (i += w)));
            ...
            function C(t, n, r, i) {
              var a, s, c, l, p;
              if (((r = null != r && W(r, 0, 8, i, g) ? 0 | r : H), !t.c))
                return t.toString();
              if (((a = t.c[0]), (c = t.e), null == n))
                (p = o(t.c)),
            ...
            return (
              ...
              (e.config = e.set = function () {
                ...
                return (
                  c((e = "DECIMAL_PLACES")) && W(t, 0, S, 2, e) && (M = 0 | t),
                  (r[e] = M),
                      ...
                      ? t
                        ? ((t = "undefined" == typeof crypto),
                          ...
                          (crypto.getRandomValues || crypto.randomBytes)
                            ? (J = !0)
                            : U
                            ? O(2, "crypto unavailable", t ? void 0 : crypto)
                            : (J = !1))
                        : (J = !1)
                      : U && O(2, e + y, t)),
                  (r[e] = J),
                ...
                return function (t) {
                  ...
                  if (
                    ...
                    if (crypto.getRandomValues) {
                      ...
                      for (r = crypto.randomBytes((a *= 7)); c < a; )
                        (s =
                    ...
                    do {
                      if (((d = 0), (f = n(D, x, F, k)), f < 0)) {
                        ...
                        if (
                          ...
                          for (; n(D, x, F, k) < 1; )
                            d++, o(x, F < k ? I : D, k, u), (k = x.length);
                      } else 0 === f && (d++, (x = [0]));
                      (b[p++] = d),
                        x[0] ? (x[k++] = T[S] || 0) : ((x = [T[S]]), (k = 1));
                ...
                return function (a, s, c, u) {
                  ...
                  if (o.test(l)) a.s = isNaN(l) ? null : l < 0 ? -1 : 1;
                    ...
                    if (
                      ...
                      u &&
                        ((f = u), (l = l.replace(n, "$1").replace(r, "0.$1"))),
                      s != l)
                    )
                      return new e(l, f);
              ...
              (E.decimalPlaces = E.dp = function () {
                ...
                if (!n) return null;
                if (
                  ((t = ((e = n.length - 1) - r(this.e / w)) * w), (e = n[e]))
                )
                  for (; e % 10 == 0; e /= 10, t--);
                return t < 0 && (t = 0), t;
              }),
              ...
              (E.minus = E.sub = function (t, n) {
                ...
                if (
                  (s && ((a = p), (p = h), (h = a), (t.s = -t.s)),
                  (n = (i = h.length) - (o = p.length)),
                  n > 0)
                )
                  for (; n--; p[o++] = 0);
                for (n = _ - 1; i > u; ) {
              ...
              (E.precision = E.sd = function (t) {
                ...
                if (
                  (null != t &&
                    ...
                    1 !== t &&
                    0 !== t &&
                    (U && O(13, "argument" + y, t), t != !!t && (t = null)),
                  !o)
                )
                  return null;
              ...
              (E.squareRoot = E.sqrt = function () {
                ...
                if (
                  ...
                  for (l = i.e, f = l + p, f < 3 && (f = 0); ; )
                    if (
                      ((s = i),
                      (i = h.times(s.plus(T(c, s, p, 1)))),
                      o(s.c).slice(0, f) === (n = o(i.c)).slice(0, f))
                    ) {
                      if (
                        (i.e < l && --f,
                        (n = n.slice(f - 3, f + 1)),
                        ...
                        (+n && (+n.slice(1) || "5" != n.charAt(0))) ||
                          (N(i, i.e + M + 2, 1), (t = !i.times(i).eq(c)));
                        break;
                      }
              ...
              (E.times = E.mul = function (t, n) {
                ...
                if (!(x && k && x[0] && k[0]))
                  return (
                    !b.s || !t.s || (x && !x[0] && !k) || (k && !k[0] && !x)
                      ? (t.c = t.e = t.s = null)
                      : ((t.s *= b.s),
                        x && k ? ((t.c = [0]), (t.e = 0)) : (t.c = t.e = null)),
                    t
                  );
                for (
                  i = r(b.e / w) + r(t.e / w),
                ...
                for (g = _, v = B, a = h; --a >= 0; ) {
                  for (
                    o = 0, d = k[a] % v, m = (k[a] / v) | 0, c = f, s = a + c;
                    s > a;
              ...
              (E.toDigits = function (t, n) {
                var r = new e(this);
                return (
                  (t = null != t && W(t, 1, S, 18, "precision") ? 0 | t : null),
              ...
              (E.toFixed = function (t, e) {
                return C(
                  this,
                  null != t && W(t, 0, S, 20) ? ~~t + this.e + 1 : null,
                  e,
                  20
                );
              }),
              (E.toFormat = function (t, e) {
                var n = C(
                  this,
                  null != t && W(t, 0, S, 21) ? ~~t + this.e + 1 : null,
                  e,
                  21
                );
                if (this.c) {
                  var r,
                    ...
                    p = l.length;
                  if (
                    (a && ((r = i), (i = a), (a = r), (p -= r)), i > 0 && p > 0)
                  ) {
                    for (r = p % i || i, c = l.substr(0, r); r < p; r += i)
                      c += s + l.substr(r, i);
                ...
                if (
                  (null != t &&
                    ...
                    ((p = c.isInt()) && !c.lt(P)) ||
                      ...
                      (t = !p && c.c && N(c, c.e + 1, 1).gte(P) ? c : null))),
                  !d)
                )
                  return h.toString();
                for (
                  l = o(d),
                    a = m.e = l.length - h.e - 1,
                    m.c[0] = k[(s = a % w) < 0 ? w + s : s],
                    t = !t || c.cmp(m) > 0 ? (a > 0 ? m : y) : c,
                    s = L,
                    L = 1 / 0,
                    c = new e(l),
                    u.c[0] = 0;
                  (f = T(c, m, 0, 1)), (i = r.plus(f.times(g))), 1 != i.cmp(t);
              ...
              (E.toPower = E.pow = function (t, n) {
                ...
                if (
                  ...
                  return (r = Math.pow(+s, t)), new e(n ? r % n : r);
                for (
                  n
                    ? t > 1 && s.gt(P) && s.isInt() && n.gt(P) && n.isInt()
                      ? (s = s.mod(n))
                      : ((i = n), (n = null))
                    : $ && (r = d($ / w + 2)),
                    o = new e(P);
              ...
              (E.toPrecision = function (t, e) {
                return C(
                  this,
                  null != t && W(t, 1, S, 24, "precision") ? 0 | t : null,
                  e,
                  24
                );
              }),
          ...
          function c(t, e, n) {
            for (var r, o, i = [0], a = 0, s = t.length; a < s; ) {
              ...
              for (i[(r = 0)] += b.indexOf(t.charAt(a++)); r < i.length; r++)
                i[r] > n - 1 &&
                  (null == i[r + 1] && (i[r + 1] = 0),
                  (i[r + 1] += (i[r] / n) | 0),
                  (i[r] %= n));
